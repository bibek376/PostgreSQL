...
----employees_dim
select
 e.employee_id, e.first_name, e.last_name,         e.email,e.phone_number,d.department_name,j.job_title  
from employees e 
...
----locations_dim
select 
    l.location_id, l.street_address,l.city, c.country_name,r.region_name 
from regions r
...
select 
		e.hire_date,e.employee_id, l.location_id,e.salary 
from employees e 
join departments d on e.department_id = d.department_id 

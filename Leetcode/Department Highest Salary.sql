...
-- 
--
--Write an SQL query to find employees who have the highest salary in each
--of the departments.
--
...
max(e.salary) over(partition by e.departmentId) "max"
from Employee e 
inner join Department d
on e.departmentId=d.id)tt
where tt.max=tt.salary;
